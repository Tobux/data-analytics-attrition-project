...
train_data_balanced <- train_data_balanced[, !(names(train_data_balanced) %in% c("JobLevel", "MonthlyIncome"))]
test_data <- test_data[, !(names(test_data) %in% c("JobLevel", "MonthlyIncome"))]
